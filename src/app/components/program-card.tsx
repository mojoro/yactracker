      ...
      <div className="mt-auto pt-4 flex items-center justify-between border-t border-slate-100">
        <div className="flex items-center gap-1.5 text-sm">
          <span className="inline-flex items-center gap-1 font-medium text-slate-900">
            <svg viewBox="0 0 16 16" fill="currentColor" className="h-3.5 w-3.5 text-slate-400" aria-hidden="true">
          ...
          <span className="inline-flex items-center gap-1 text-slate-500 whitespace-nowrap">
            <svg viewBox="4 3 24 26" fill="currentColor" className="h-3.5 w-3.5 text-slate-400" aria-hidden="true">
          ...
          <span className="inline-flex items-center gap-1 text-slate-500">
            <svg viewBox="0 0 16 16" fill="none" className="h-3.5 w-3.5 text-slate-400" aria-hidden="true">
